odoo.define('erplibre_snippet_simple_dialog.widgets', function (require) {
    "use strict";
    ...
    var result = $.Deferred(),
        _templates_loaded = ajax.loadXML(
            "/erplibre_snippet_simple_dialog/static/src/xml/widgets.xml",
            core.qweb
        );


    var ParamsForm = Dialog.extend({
        template: "erplibre_snippet_simple_dialog.ParamsForm",
    ...
    sAnimation.registry.simple_dialog = sAnimation.Class.extend({
        selector: '.simple_dialog',
    ...
    //options.registry.erplibre_snippet_simple_dialog = Form;
