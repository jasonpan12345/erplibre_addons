odoo.define("erplibre_snippet_multiple_dialog.animation", function (require) {
    "use strict";

    let sAnimation = require("website.content.snippets.animation");

    sAnimation.registry.erplibre_snippet_multiple_dialog =
        sAnimation.Class.extend({
            selector: ".o_erplibre_snippet_multiple_dialog",
            ...
            start: function () {
                ...
                let def = this._rpc({
                    route: "/erplibre_snippet_multiple_dialog/get_last_item",
                }).then(function (data) {
                    if (data.error) {
                        return;
                    }
                    ...
                    if (_.isEmpty(data)) {
                        self.$(
                            ".o_loading_erplibre_snippet_multiple_dialog"
                        ).text("NO DATA");
                        return;
                    }
